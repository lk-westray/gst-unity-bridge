...
// NOTE: Declare functions already defined in export.c

DVBCSSWCserver* server_new(void);
// {
...
DVBCSSWCserver* gst_dvb_css_wc_start(const gchar *address, gint port, gboolean followup, guint32 max_freq_error_ppm,  gboolean isDebug);
// {
...
void gst_dvb_css_wc_stop(DVBCSSWCserver* sServer);
// {
...
GstClockTime gst_dvb_css_wc_get_time(DVBCSSWCserver* sServer);
// {
// 	GstClockTime time;
// 	G_LOCK(mutex);
